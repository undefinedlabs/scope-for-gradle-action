...
export async function instrument(agentVersion:string, scopeGradlePluginVersion:string): Promise<void> {
    ...
    const gradleInstrumentatorPath = await tc.downloadTool("https://repo1.maven.org/maven2/com/undefinedlabs/scope/scope-instrumentation-for-gradle/0.1.0-beta.1/scope-instrumentation-for-maven-0.1.0-beta.1.jar");
